...
- `tuned-tensor-fine-tune`: create specs, validate, push, start runs, inspect regressions, and upload datasets.
- `tuned-tensor-serve-local`: download, configure, serve, test, and troubleshoot local model serving.
